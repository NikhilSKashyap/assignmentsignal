...
--------------------
Unit tests for assignment.core.grader — transcript builder and config resolution.
...
class TestSummariseToolInput:
    def _call(self, tool, inp):
        from assignment.core.grader import _summarise_tool_input
...
class TestGetApiKey:
    def _call(self):
        from assignment.core.grader import _get_api_key
        return _get_api_key()
...
class TestGetLlmConfig:
    def _call(self):
        from assignment.core.grader import _get_llm_config
